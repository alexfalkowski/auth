...
var file_auth_v1_service_proto_rawDesc = []byte{
	...
	0x72, 0x32, 0xed, 0x04, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x79, 0x0a,
	...
	0x65, 0x42, 0x36, 0x5a, 0x29, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x61, 0x6c, 0x65, 0x78, 0x66, 0x61, 0x6c, 0x6b, 0x6f, 0x77, 0x73, 0x6b, 0x69, 0x2f, 0x61, 0x75,
	0x74, 0x68, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x76, 0x31, 0xea, 0x02,
...
var file_auth_v1_service_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_auth_v1_service_proto_goTypes = []interface{}{
	...
	nil,                                  // 14: auth.v1.GeneratePasswordResponse.MetaEntry
	nil,                                  // 15: auth.v1.GenerateKeyResponse.MetaEntry
	nil,                                  // 16: auth.v1.GetPublicKeyResponse.MetaEntry
	nil,                                  // 17: auth.v1.GenerateAccessTokenResponse.MetaEntry
	nil,                                  // 18: auth.v1.GenerateServiceTokenResponse.MetaEntry
}
var file_auth_v1_service_proto_depIdxs = []int32{
	14, // 0: auth.v1.GeneratePasswordResponse.meta:type_name -> auth.v1.GeneratePasswordResponse.MetaEntry
	2,  // 1: auth.v1.GeneratePasswordResponse.password:type_name -> auth.v1.Password
	15, // 2: auth.v1.GenerateKeyResponse.meta:type_name -> auth.v1.GenerateKeyResponse.MetaEntry
	5,  // 3: auth.v1.GenerateKeyResponse.key:type_name -> auth.v1.Key
	16, // 4: auth.v1.GetPublicKeyResponse.meta:type_name -> auth.v1.GetPublicKeyResponse.MetaEntry
	17, // 5: auth.v1.GenerateAccessTokenResponse.meta:type_name -> auth.v1.GenerateAccessTokenResponse.MetaEntry
	...
	18, // 8: auth.v1.GenerateServiceTokenResponse.meta:type_name -> auth.v1.GenerateServiceTokenResponse.MetaEntry
	13, // 9: auth.v1.GenerateServiceTokenResponse.token:type_name -> auth.v1.ServiceToken
	0,  // 10: auth.v1.Service.GeneratePassword:input_type -> auth.v1.GeneratePasswordRequest
	3,  // 11: auth.v1.Service.GenerateKey:input_type -> auth.v1.GenerateKeyRequest
	6,  // 12: auth.v1.Service.GetPublicKey:input_type -> auth.v1.GetPublicKeyRequest
	8,  // 13: auth.v1.Service.GenerateAccessToken:input_type -> auth.v1.GenerateAccessTokenRequest
	11, // 14: auth.v1.Service.GenerateServiceToken:input_type -> auth.v1.GenerateServiceTokenRequest
	1,  // 15: auth.v1.Service.GeneratePassword:output_type -> auth.v1.GeneratePasswordResponse
	4,  // 16: auth.v1.Service.GenerateKey:output_type -> auth.v1.GenerateKeyResponse
	7,  // 17: auth.v1.Service.GetPublicKey:output_type -> auth.v1.GetPublicKeyResponse
	9,  // 18: auth.v1.Service.GenerateAccessToken:output_type -> auth.v1.GenerateAccessTokenResponse
	12, // 19: auth.v1.Service.GenerateServiceToken:output_type -> auth.v1.GenerateServiceTokenResponse
